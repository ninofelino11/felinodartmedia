...
*/
public class Tclaimdt extends BaseEntity implements Cloneable{

    public Tclaimdt(){ super();}
    ...
    private String claim_gb;
    private String do_flag;
    private String claim_code;
    private String exch_pair;
    ...
    private long   syslast_org;
    private long   cancel_qty_cur;
    private String cancel_flag;
    private String repay_gb_org;
    private String as_can_confirm;
    private String as_wh_code;
	...
	public String getClaim_gb() {
		return claim_gb;
	}

	public void setClaim_gb(String claim_gb) {
		this.claim_gb = claim_gb;
	}
	...
	public String getExch_pair() {
		return exch_pair;
	}

	public void setExch_pair(String exch_pair) {
		this.exch_pair = exch_pair;
	}
	...
	public long getClaim_qty() {
		return claim_qty;
	}

	public void setClaim_qty(long claim_qty) {
	...
	public double getClaim_amt() {
		return claim_amt;
	}

	public void setClaim_amt(double claim_amt) {
	...
	public String getRepay_gb() {
		return repay_gb;
	}

	public void setRepay_gb(String repay_gb) {
		this.repay_gb = repay_gb;
	}
	...
	public long getSyslast_org() {
		return syslast_org;
	}

	public void setSyslast_org(long syslast_org) {
		this.syslast_org = syslast_org;
	}

	public long getCancel_qty_cur() {
		return cancel_qty_cur;
	}

	public void setCancel_qty_cur(long cancel_qty_cur) {
		this.cancel_qty_cur = cancel_qty_cur;
	}
	...
	public String getRepay_gb_org() {
		return repay_gb_org;
	}

	public void setRepay_gb_org(String repay_gb_org) {
		this.repay_gb_org = repay_gb_org;
	}

	public String getAs_can_confirm() {
		return as_can_confirm;
	}

	public void setAs_can_confirm(String as_can_confirm) {
		this.as_can_confirm = as_can_confirm;
	}

	public String getAs_wh_code() {
		return as_wh_code;
	}

	public void setAs_wh_code(String as_wh_code) {
		this.as_wh_code = as_wh_code;
	}

	public String getAs_note() {
		return as_note;
	}

	public void setAs_note(String as_note) {
		this.as_note = as_note;
	}
