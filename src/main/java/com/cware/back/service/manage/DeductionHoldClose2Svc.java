...
/**
 * Excute DeductionHoldClose2 Service class
 *
 * @version 1.0, 2010/12/31
 */
public class DeductionHoldClose2Svc {


    //private static Log log      = LogFactory.getLog(Construct.LOG_BASE);
    private static Log logSave  = LogFactory.getLog(Construct.LOG_SAVE);

    public DeductionHoldClose2Svc() {}
    ...
    */
    public RetrieveModel execProcedure(Connection con, RetrieveModel retrieve) throws StoreException{
        ...
        try {
            ...
            cstmt = con.prepareCall("begin SP_TSDACCTPAYDT(?, ?, ?, ?, ?, ?); end;");
            ...
            logSave.error("[DeductionHoldClose2Svc.execProcedure() SQLException : ERR-"+se.getErrorCode()+":"+se);
            throw new StoreException(se.getMessage());
        }catch(Exception e){
            logSave.error("[DeductionHoldClose2Svc.execProcedure() Exception : ERR-"+e.getMessage());
