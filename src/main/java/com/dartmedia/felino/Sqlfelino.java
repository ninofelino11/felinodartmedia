...
public class Sqlfelino implements Serializable {
    ...
    public Sqlfelino(String bankCode) {
        this.bankCode = bankCode;
    }

    public Sqlfelino(String bankCode, String bankName, String useYn, String insertId, Date insertDate) {
        this.bankCode = bankCode;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Sqlfelino)) {
            return false;
        }
        Sqlfelino other = (Sqlfelino) object;
