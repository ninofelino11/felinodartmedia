 ...
 */
@Embeddable
public class TpromogiftPK implements Serializable {
    ...
    public TpromogiftPK(String promoNo, String promoSeq) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TpromogiftPK)) {
            return false;
        }
        TpromogiftPK other = (TpromogiftPK) object;
    ...
    public String toString() {
        return "com.dartmedia.felino.TpromogiftPK[ promoNo=" + promoNo + ", promoSeq=" + promoSeq + " ]";
    }
