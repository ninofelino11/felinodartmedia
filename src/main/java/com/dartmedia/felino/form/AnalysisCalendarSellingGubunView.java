...
@CDIView("AnalysisCalendarSellingGubun")
public class AnalysisCalendarSellingGubunView extends MVerticalLayout implements View {
//AnalysisCalendarSellingGubunSvc data=new AnalysisCalendarSellingGubunSvc();
    @PostConstruct
...
toolmenu.addComponent(new Button("XLS"));
        addComponents(
                new Header("Sales Report[Calendar] (AnalysisCalendarSellingGubun)"
        ));
