...
//sb.append("");
sb1.append("SELECT /* customer.xml : custcenter.customer.selectReceiver by CustDetail */");
sb1.append("               A.RECEIVER_GB,");
sb1.append("               A.DEFAULT_YN,");
sb1.append("               A.RECEIVER_DDD,");
sb1.append("               A.RECEIVER_TEL1,");
sb1.append("               A.RECEIVER_TEL2,");
sb1.append("               A.RECEIVER_TEL3,");
sb1.append("               A.TEL,");
sb1.append("               A.RECEIVER_HP1,");
sb1.append("               A.RECEIVER_HP2,");
sb1.append("               A.RECEIVER_HP3,");
sb1.append("               A.RECEIVER_HP,");
sb1.append("               A.RECEIVER_HP1_SE,");
sb1.append("               A.RECEIVER_HP2_SE,");
sb1.append("               A.RECEIVER_HP3_SE,");
sb1.append("               A.RECEIVER_POST,");
sb1.append("               FUN_ADD_POSTADDR(A.RECEIVER_POST,A.RECEIVER_POST_SEQ,'') AS COMP_ADDR,");
sb1.append("               A.RECEIVER_ADDR,");
sb1.append("               A.RECEIVER_SEQ,");
sb1.append("               A.RECEIVER_POST_SEQ,");
sb1.append("               A.CUST_NO,");
sb1.append("               A.RECEIVER,");
sb1.append("               A.RECEIVER1,");
sb1.append("               A.RECEIVER2,");
sb1.append("               A.RECEIVER3,");
sb1.append("               A.INSERT_ID,");
sb1.append("               TO_CHAR(A.INSERT_DATE,'YYYY/MM/DD HH24:MI:SS') INSERT_DATE,");
sb1.append("               A.MODIFY_ID,");
sb1.append("               TO_CHAR(A.MODIFY_DATE,'YYYY/MM/DD HH24:MI:SS') MODIFY_DATE");
sb1.append("          FROM TRECEIVER  A");
sb1.append("         WHERE A.CUST_NO           = '201208007267'");
sb1.append("           AND A.USE_YN            = '1'");
sb1.append("           AND A.RECEIVER_GB       = '00'");
sb1.append("         ORDER BY A.RECEIVER_GB,");
sb1.append("               A.RECEIVER_SEQ,");
sb1.append("               A.RECEIVER_POST");
sb.append("");
