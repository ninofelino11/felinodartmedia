...
sb.append("");
sb.append("SELECT  /* warehousemove.xml : logistics.warehousemove.selectWhInConfirm by WhInConfirm */");
...
sb.append("                 NVL(OD.OUT_AQTY - NVL(SUM(ID.IN_AQTY),0), 0) AS POSSIBLE_IN_AQTY,                   ");
sb.append("                 NVL(OD.OUT_BQTY - NVL(SUM(ID.IN_BQTY),0), 0) AS POSSIBLE_IN_BQTY,                   ");
sb.append("                 0 AS IN_AQTY,                                                                    ");
sb.append("                 0 AS IN_BQTY,                                                                  ");
sb.append("                 OD.MOVE_OUT_SEQ                                                                  ");
sb.append("            FROM TWHMOVEOUTDT OD,                                                                 ");
sb.append("                 TGOODSDT      G,                                                               ");
sb.append("                 (SELECT AA.GOODS_CODE,                                                         ");
...
sb.append("                   WHERE AA.MOVE_IN_SEQ = BB.MOVE_IN_SEQ                                        ");
sb.append("                     AND BB.MOVE_OUT_SEQ = 201212210026                                                       ");
sb.append("                  GROUP BY AA.GOODS_CODE,                                                       ");
sb.append("                         AA.GOODSDT_CODE,                                                       ");
sb.append("                         AA.MOVE_IN_SEQ,                                                        ");
sb.append("                         BB.MOVE_OUT_SEQ) ID                                                    ");
sb.append("           WHERE OD.MOVE_OUT_SEQ = Id.MOVE_OUT_SEQ(+)                                            ");
...
sb.append("             AND OD.MOVE_OUT_SEQ = 201212210026                                                           ");
sb.append("         GROUP BY OD.GOODS_CODE,                                                                ");
sb.append("                  OD.GOODSDT_CODE,                                                               ");
sb.append("                  G.GOODS_NAME,                                                                     ");
sb.append("                  G.GOODSDT_INFO,                                                               ");
sb.append("                  OD.OUT_AQTY,                                                                   ");
sb.append("                  OD.OUT_BQTY,                                                                   ");
sb.append("                   OD.MOVE_OUT_SEQ ");
...
//-------------------- Header  ------------------------------
toolbar.addComponent(new TextField("Request No"));
toolbar.addComponent(new ComboBox("receiptMy ComboBox"));
...
toolmenu.addComponent(new Button("XLS"));
        addComponents(
                new Header("Wh Transfer In (WhInConfirm)"
        ));
