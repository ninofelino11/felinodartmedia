...
@CDIView("AnalysisCalendarMonthSelling")
public class AnalysisCalendarMonthSellingView extends MVerticalLayout implements View {
//AnalysisCalendarMonthSellingSvc data=new AnalysisCalendarMonthSellingSvc();
    @PostConstruct
...
toolmenu.addComponent(new Button("XLS"));
        addComponents(
                new Header("Compare Sales Report[Calendar] (AnalysisCalendarMonthSelling)"
        ));
